...
public interface DiaryService {
    ...
    List<DiaryDTO> findStateDiaries(String memberID, Boolean state); // 활성화 or 비활성화된 상태의 일기장 목록 조회

    List<DiaryDTO> findRepliedDiaries(String loginMemberID); // 답장 온 일기장 목록 조회
